...
export const cssMap = {
  ...
  body: 'sd-body sd-body--responsive survey-custom-body',
  ...
  navigationButton: '',
  bodyNavigationButton: 'sv-action button',
  // completedPage: 'sd-completedpage',
  completedPage: 'custom-completed-page',
  ...
  panel: {
    ...
    content: 'survey-custom-panel-content',
    icon: 'sd-panel__icon',
  ...
  paneldynamic: {
    ...
    // header: 'survey-paneldynamic-custom-header',
    headerTab: 'sd-paneldynamic__header-tab',
    button: 'survey-paneldynamic-custom-action',
    buttonRemove: 'button button--secondary',
    buttonAdd: 'button button--secondary',
    buttonPrev: 'button button--secondary',
    buttonNext: 'button button--secondary',
    ...
    nested: 'sd-element--nested sd-element--nested-with-borders',
    // progressText: 'survey-paneldynamic-custom-progress-text',
    // separator: 'survey-paneldynamic-custom-separator',
    panelWrapper: 'sd-paneldynamic__panel-wrapper',
    // footer: 'survey-paneldynamic-custom-footer',
    panelFooter: 'survey-paneldynamic-custom-panel-footer',
    // footerButtonsContainer: 'survey-paneldynamic-custom-footer-buttons-container',
    ...
    // compact: 'survey-paneldynamic-custom-compact',
    tabsRoot: 'survey-paneldynamic-custom-tabs-root',
    tabsLeft: 'sd-tabs-toolbar--left',
    tabsRight: 'sd-tabs-toolbar--right',
    tabsCenter: 'sd-tabs-toolbar--center',
    tabs: {
      item: 'survey-paneldynamic-custom-tab-item',
      itemPressed: 'survey-paneldynamic-custom-tab-item--active',
  ...
  matrix: {
    ...
    cell: 'custom-matrix-cell',
    row: 'custom-matrix-row',
    rowDisabled: 'sd-table__row-disabled',
    headerCell: 'custom-matrix-header-cell',
    rowTextCell: 'sd-table__cell sd-matrix__cell sd-table__cell--row-text custom-matrix-row-text-cell',
